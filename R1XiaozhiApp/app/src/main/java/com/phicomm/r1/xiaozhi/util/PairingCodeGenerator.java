...
public class PairingCodeGenerator {
     ...
     *
     * NOTE: this is a local, display-only code - it is NOT the real
     * verification code accepted by the Xiaozhi server. The real flow
     * (see DeviceActivator / HTTPServerService#serveAuthorize) uses the
     * server-issued challenge/code from the OTA response instead.
     */
